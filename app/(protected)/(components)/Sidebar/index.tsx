...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
    ...
    return (
        <ClickOutside onClick={() => setSidebarOpen(false)}>
            <aside
                className={`absolute bg-secondary text-secondary-content left-0 top-0 z-[2] flex h-screen w-72.5 flex-col overflow-y-hidden shadow-md border-stroke  lg:static lg:translate-x-0 ${
                    sidebarOpen
