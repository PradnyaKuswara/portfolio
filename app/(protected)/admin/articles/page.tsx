                    ...
                    <tr key={index} className="hover">
                      <td>
                        {article.is_active ? (
                          <button
                            ...
                            onClick={() => handleStatusChange(article.slug)}
                          >
                            active
                          </button>
                        ) : (
                      ...
                      <td>
                        {article.tags.map((tag, index) => (
                          <span key={index} className="text-accent mr-2">
                            {tag.name}
                          </span>
                        ))}
                      </td>
                      <td>{limitdesc(article.meta_desc)}</td>
                      ...
                      <td className="flex gap-2">
                        ...
                        <DeleteButton
                          ...
                          endPoint="articles"
                          mutatePoint={[`articles`, currentPage, searchQuery]}
                        />
                      </td>
                    </tr>
                  ))
